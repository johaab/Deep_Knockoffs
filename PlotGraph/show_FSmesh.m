...
FSSURFPATH=fullfile(FSROOTPATH,'BrainGraphTools','fsaverage','surf');
...
for h=1:numel(hemi)
    ...
    if (useConvexHull==true)
        ...
        p=trisurf(myConvHull+1,vertices(:,1),vertices(:,2),vertices(:,3),...
        ...
        p=trisurf(faces+1,vertices(:,1),vertices(:,2),vertices(:,3),...
